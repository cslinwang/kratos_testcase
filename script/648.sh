...
# Bug url
# https://github.com/KratosMultiphysics/Kratos/issues/648

# 预期报错：
# Traceback (most recent call last):
#   File "MainKratos.py", line 3, in <module>
#     import MainKratosSolid
# ImportError: No module named 'MainKratosSolid'

# 运行文件
# /root/Kratos/applications/SolidMechanicsApplication/tests/test_SolidMechanicsApplication.py
...
# 运行
echo "开始运行测试用例..."
cd /root/Kratos/applications/SolidMechanicsApplication/tests
python3 /root/Kratos/applications/SolidMechanicsApplication/tests/test_SolidMechanicsApplication.py
echo "测试用例运行完成。"

# 生成覆盖率报告
# /root/kratos_testcase/script/coverage.sh 648
