...
cp /root/kratos_testcase/script/buildkratosv6.sh /root/Kratos/cmake_build/buildkratosv6.sh
sh /root/Kratos/cmake_build/buildkratosv6.sh 2>&1 | tee /root/kratos_testcase/script/kratos_build.log
echo "Kratos编译完成。"
