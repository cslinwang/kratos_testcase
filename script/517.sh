...
# Bug url
# https://github.com/KratosMultiphysics/Kratos/issues/517

# 预期报错：


# 运行文件
# /root/kratos_testcase/517/MainKratos.py
...
# 运行
echo "开始运行测试用例..."
cd /root/kratos_testcase/517
python3 /root/kratos_testcase/517/MainKratos.py
echo "测试用例运行完成。"

# 生成覆盖率报告
# /root/kratos_testcase/script/coverage.sh 517
