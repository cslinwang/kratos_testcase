...
cp /root/kratos_testcase/script/buildkratosv7_7.1.sh /root/Kratos/cmake_build/buildkratosv7_7.1.sh
sh /root/Kratos/cmake_build/buildkratosv7_7.1.sh 2>&1 | tee /root/kratos_testcase/script/kratos_build.log
echo "Kratos编译完成。"
