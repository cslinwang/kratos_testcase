...
main_model_part.GetNode(1).Fix(DISPLACEMENT_X)
main_model_part.GetNode(1).Fix(DISPLACEMENT_Y)
main_model_part.GetNode(1).Fix(DISPLACEMENT_Z)
main_model_part.GetNode(1).Fix(ROTATION_X)
main_model_part.GetNode(1).Fix(ROTATION_Y)
main_model_part.GetNode(1).Fix(ROTATION_Z)
main_model_part.GetNode(2).Fix(DISPLACEMENT_X)
main_model_part.GetNode(2).Fix(DISPLACEMENT_Z)
main_model_part.GetNode(2).Fix(ROTATION_X)
main_model_part.GetNode(2).Fix(ROTATION_Y)
main_model_part.GetNode(2).SetSolutionStepValue(POINT_LOAD_Y, -2.864788975654116)
