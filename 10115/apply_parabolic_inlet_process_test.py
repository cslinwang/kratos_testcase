...
class ApplyParabolicInletProcessTest(UnitTest.TestCase):
    ...
    def testUnitParabolaScalar2D(self):
        ...
        self.assertLessEqual(abs(test_node.GetValue(
            KratosBio.WALL_DISTANCE) - 0.9999971715808751), 1.0e-6)
        ...
        self.assertVectorAlmostEqual(test_node.GetSolutionStepValue(
            KratosMultiphysics.VELOCITY), [0.0, 1.0, 0.0])
    ...
    def testUnitParabolaString2D(self):
        ...
        self.assertTrue(test_node.IsFixed(KratosMultiphysics.VELOCITY_Z))
        self.assertVectorAlmostEqual(test_node.GetSolutionStepValue(
            KratosMultiphysics.VELOCITY), [0.0, 0.0, 0.0])
        ...
        self.assertTrue(test_node.IsFixed(KratosMultiphysics.VELOCITY_Z))
        self.assertVectorAlmostEqual(test_node.GetSolutionStepValue(
            KratosMultiphysics.VELOCITY), [0.0, 2.0, 0.0])
    ...
    def testUnitParabolaFlowRateTable2D(self):
        ...
        self.assertTrue(test_node.IsFixed(KratosMultiphysics.VELOCITY_Z))
        self.assertVectorAlmostEqual(test_node.GetSolutionStepValue(
            KratosMultiphysics.VELOCITY), [0.0, 0.25, 0.0])
